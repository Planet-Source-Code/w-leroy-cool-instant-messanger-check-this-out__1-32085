...
Private Sub Form_Load()
    ...
    'load the database
    dbv.DatabaseName = App.Path & "\env\server.mdb"
    
    dbv.RecordSource = "Client"
    
    'assotiate the labels with the database to view the data
    
    lUserID.DataField = "UserID"
    
    lPass.DataField = "uPassword"
    
    lCreated.DataField = "ccDate"
